    ...
    m("fieldset", [
      m("div.pure-control-group", [
        ...
        m("input#form-goal-name", {
          class: "form-control",
          oninput: (function(ev) {this.name = ev.target.value}).bind(vnode.state.goal),
      ...
      m("div.pure-control-group", [
        ...
        m("input#form-goal-target", {
          class: "form-control",
          oninput: (function(ev) {this.target = parseFloat(ev.target.value)}).bind(vnode.state.goal),
