...
var NoGoalsNotice = {
  view: function(vnode) {
    return m("div", {style: "text-align: center;"}, [
      ...
      m("a", {class: "pure-button", style: "margin: 0.5rem", href: "#!/create-goal"}, "Add a goal")
    ])
  }
}
...
var GoalsListPage = {
  ...
  view: function(vnode) {
    ...
    return m("div", [
            ...
            for (var i in goals) {
              ...
              rows.push(m("tr", [
                m("td", m("div.tv-goal-list-item", [
                  m("div", m("a.tv-goal-list-name[href=#!/goals/"+goal.id+"]", goal.name + (goal.archived ? " (archived)" : ""))),
      ...
      m("a[href=#!/create-goal]", {class: "pure-button tv-add-another-goal-button"}, "Add another goal")
    ])
  }
}
